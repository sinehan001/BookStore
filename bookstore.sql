...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 23, 2024 at 12:07 PM
...
--
ALTER TABLE `orders_history`
  ADD CONSTRAINT `orders_history_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `orders_history_ibfk_2` FOREIGN KEY (`order_id`) REFERENCES `orders` (`id`),
  ADD CONSTRAINT `orders_history_ibfk_3` FOREIGN KEY (`book_id`) REFERENCES `books` (`id`);
COMMIT;
